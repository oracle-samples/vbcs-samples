...
define([
  ...
  class initializeVariables extends ActionChain {
    ...
    async run(context, { configuration }) {
      ...
      $page.variables.enhancedDP = DataProviderFactory.getEnhancedDataProvider( $page.variables.employeeListSDP, {fetchFirst : { caching: 'visitedByCurrentIterator' }});
    }
  }
