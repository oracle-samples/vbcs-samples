...
define(['vb/test/TestUtils'], function(TestUtils) {
  ...
  describe('webApps/vbcookbookshell/flows/table-actions/pages/table-actions-demo-page', function() {

      describe('OpenDialogChain', function() {

          it('OpenDialog', async function() {
