...
define([
  ...
  class saveEmployeeChain3 extends ActionChain {
    ...
    async run(context, { employeeId = '100' }) {
      ...
      try {
        ...
        const validateFormResult = await Actions.callChain(context, {
          ...
          params: {
            validationGroupId: 'employee-validation-group--207698439-3',
          },
        }, { id: 'validateEmployee' });
        ...
        const payload = await this.preparePatchPayload(context, {
          updatedRecord: $variables.employee3,
          fetchedRecord: $variables.fetchedEmployee3,
        });
        ...
        const callRestResult = await Actions.callRest(context, {
          ...
          headers: $variables.employeeETag3 ? { 'If-Match': $variables.employeeETag3 } : null,
          requestType: 'json',
          uriParams: {
        ...
        await Actions.callChain(context, {
          chain: 'loadEmployeeChain3',
          params: {
            fetchedFields: $variables.employeeEditFormRenderedFields3,
          },
