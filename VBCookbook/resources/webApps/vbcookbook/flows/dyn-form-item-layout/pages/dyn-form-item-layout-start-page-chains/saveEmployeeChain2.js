...
define([
  ...
  class saveEmployeeChain2 extends ActionChain {
    ...
    async run(context, { employeeId = '100' }) {
      ...
      $page.variables.employeeEditFormLoadingStatus2 = 'pending';
      ...
      try {
        ...
        const validateFormResult = await Actions.callChain(context, {
          ...
          params: {
            validationGroupId: 'employee-validation-group--207698439-2',
          },
        }, { id: 'validateEmployee' });
        ...
        $page.variables.employee2.department = $page.variables.employee2.departmentMock.id;
        
        const payload = await this.preparePatchPayload(context, {

          updatedRecord: $page.variables.employee2,
          fetchedRecord: $page.variables.fetchedEmployee2,
        });
        ...
        //deleting 
        delete payload.departmentObject;
        delete payload.departmentMock;
        ...
        const callRestResult = await Actions.callRest(context, {
          ...
          headers: $page.variables.employeeETag2 ? { 'If-Match': $page.variables.employeeETag2 } : null,
          requestType: 'json',
          uriParams: {
        ...
        await Actions.callChain(context, {
          chain: 'loadEmployeeChain2',
          params: {
            fetchedFields: $page.variables.employeeEditFormRenderedFields2,
          },
        }, { id: 'callLoadEmployeeChain' });
      } finally {
        // Updates form status to Ready.
        $page.variables.employeeEditFormLoadingStatus2 = 'ready';
      }
    }
