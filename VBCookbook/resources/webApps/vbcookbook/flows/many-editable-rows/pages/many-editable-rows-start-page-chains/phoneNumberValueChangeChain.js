...
define([
  ...
  class phoneNumberValueChangeChain extends ActionChain {
    ...
    async run(context, { newValue, row }) {
      ...
      let updatedRow = { "id" : row.id, "phoneNumber": newValue, "phoneType" : row.phoneType  };
  ...
  return phoneNumberValueChangeChain;
});
